...
80100394:	e8 b7 02 00 00       	call   80100650 <cprintf>
  cprintf("\n");
80100399:	c7 04 24 27 79 10 80 	movl   $0x80107927,(%esp)
...
80100b70:	e8 8b 5e 00 00       	call   80106a00 <freevm>
  return -1;
...
80100ba7:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80100bae:	00 
80100baf:	c7 04 24 10 6f 10 80 	movl   $0x80106f10,(%esp)
80100bb6:	e8 95 fa ff ff       	call   80100650 <cprintf>
  for(argc = 0; argv[argc]; argc++) {
80100bbb:	8b 45 0c             	mov    0xc(%ebp),%eax
80100bbe:	8b 00                	mov    (%eax),%eax
80100bc0:	85 c0                	test   %eax,%eax
80100bc2:	0f 84 71 01 00 00    	je     80100d39 <exec+0x399>
80100bc8:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80100bcb:	31 d2                	xor    %edx,%edx
  sp = KERNBASE-1;
80100bcd:	bb ff ff ff 7f       	mov    $0x7fffffff,%ebx
80100bd2:	8d 71 04             	lea    0x4(%ecx),%esi
  for(argc = 0; argv[argc]; argc++) {
80100bd5:	89 cf                	mov    %ecx,%edi
80100bd7:	89 d1                	mov    %edx,%ecx
80100bd9:	89 f2                	mov    %esi,%edx
80100bdb:	89 fe                	mov    %edi,%esi
80100bdd:	89 cf                	mov    %ecx,%edi
80100bdf:	eb 13                	jmp    80100bf4 <exec+0x254>
...
80100bfd:	e8 ae 38 00 00       	call   801044b0 <strlen>
...
80100c0e:	e8 9d 38 00 00       	call   801044b0 <strlen>
...
80100c2d:	e8 3e 61 00 00       	call   80106d70 <copyout>
...
80100c9a:	89 95 60 ff ff ff    	mov    %edx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100ca0:	e8 cb 60 00 00       	call   80106d70 <copyout>
...
80100ced:	e8 7e 37 00 00       	call   80104470 <safestrcpy>
  sz = PGROUNDUP(sz);
...
80100d25:	e8 56 59 00 00       	call   80106680 <switchuvm>
  freevm(oldpgdir);
80100d2a:	89 34 24             	mov    %esi,(%esp)
80100d2d:	e8 ce 5c 00 00       	call   80106a00 <freevm>
  return 0;
...
80100d56:	c7 44 24 04 3c 6f 10 	movl   $0x80106f3c,0x4(%esp)
80100d5d:	80 
...
80100e16:	c3                   	ret    
    panic("filedup");
80100e17:	c7 04 24 43 6f 10 80 	movl   $0x80106f43,(%esp)
...
80100ed7:	e9 b4 1c 00 00       	jmp    80102b90 <end_op>
    panic("fileclose");
80100edc:	c7 04 24 4b 6f 10 80 	movl   $0x80106f4b,(%esp)
...
80100fc5:	eb d8                	jmp    80100f9f <fileread+0x5f>
  panic("fileread");
80100fc7:	c7 04 24 55 6f 10 80 	movl   $0x80106f55,(%esp)
...
801010dc:	e9 1f 22 00 00       	jmp    80103300 <pipewrite>
        panic("short filewrite");
801010e1:	c7 04 24 5e 6f 10 80 	movl   $0x80106f5e,(%esp)
801010e8:	e8 73 f2 ff ff       	call   80100360 <panic>
  panic("filewrite");
801010ed:	c7 04 24 64 6f 10 80 	movl   $0x80106f64,(%esp)
...
801011a5:	c7 04 24 6e 6f 10 80 	movl   $0x80106f6e,(%esp)
...
801012cd:	c7 04 24 84 6f 10 80 	movl   $0x80106f84,(%esp)
...
80101385:	eb 93                	jmp    8010131a <bmap+0x3a>
  panic("bmap: out of range");
80101387:	c7 04 24 94 6f 10 80 	movl   $0x80106f94,(%esp)
...
80101469:	c7 04 24 a7 6f 10 80 	movl   $0x80106fa7,(%esp)
...
8010148c:	c7 44 24 04 ba 6f 10 	movl   $0x80106fba,0x4(%esp)
80101493:	80 
...
801014a9:	c7 44 24 04 c1 6f 10 	movl   $0x80106fc1,0x4(%esp)
801014b0:	80 
...
801014d6:	c7 04 24 24 70 10 80 	movl   $0x80107024,(%esp)
...
801015f1:	c7 04 24 c7 6f 10 80 	movl   $0x80106fc7,(%esp)
...
80101774:	0f 85 76 ff ff ff    	jne    801016f0 <ilock+0x30>
      panic("ilock: no type");
8010177a:	c7 04 24 df 6f 10 80 	movl   $0x80106fdf,(%esp)
80101781:	e8 da eb ff ff       	call   80100360 <panic>
    panic("ilock");
80101786:	c7 04 24 d9 6f 10 80 	movl   $0x80106fd9,(%esp)
...
801017ce:	e9 1d 28 00 00       	jmp    80103ff0 <releasesleep>
    panic("iunlock");
801017d3:	c7 04 24 ee 6f 10 80 	movl   $0x80106fee,(%esp)
...
80101c71:	c3                   	ret    
      panic("dirlookup read");
80101c72:	c7 04 24 08 70 10 80 	movl   $0x80107008,(%esp)
80101c79:	e8 e2 e6 ff ff       	call   80100360 <panic>
    panic("dirlookup not DIR");
80101c7e:	c7 04 24 f6 6f 10 80 	movl   $0x80106ff6,(%esp)
...
80101ef3:	eb e9                	jmp    80101ede <dirlink+0xae>
      panic("dirlink read");
80101ef5:	c7 04 24 17 70 10 80 	movl   $0x80107017,(%esp)
...
80101fef:	c7 04 24 80 70 10 80 	movl   $0x80107080,(%esp)
80101ff6:	e8 65 e3 ff ff       	call   80100360 <panic>
    panic("idestart");
80101ffb:	c7 04 24 77 70 10 80 	movl   $0x80107077,(%esp)
...
80102016:	c7 44 24 04 92 70 10 	movl   $0x80107092,0x4(%esp)
8010201d:	80 
...
801021e9:	eb bb                	jmp    801021a6 <iderw+0x76>
    panic("iderw: buf not locked");
801021eb:	c7 04 24 96 70 10 80 	movl   $0x80107096,(%esp)
801021f2:	e8 69 e1 ff ff       	call   80100360 <panic>
    panic("iderw: ide disk 1 not present");
801021f7:	c7 04 24 c1 70 10 80 	movl   $0x801070c1,(%esp)
801021fe:	e8 5d e1 ff ff       	call   80100360 <panic>
    panic("iderw: nothing to do");
80102203:	c7 04 24 ac 70 10 80 	movl   $0x801070ac,(%esp)
...
80102258:	c7 04 24 e0 70 10 80 	movl   $0x801070e0,(%esp)
...
8010238c:	eb bb                	jmp    80102349 <kfree+0x49>
    panic("kfree");
8010238e:	c7 04 24 12 71 10 80 	movl   $0x80107112,(%esp)
...
801023fb:	c7 44 24 04 18 71 10 	movl   $0x80107118,0x4(%esp)
80102402:	80 
...
80102de6:	e8 75 38 00 00       	call   80106660 <switchkvm>
  seginit();
80102deb:	e8 30 37 00 00       	call   80106520 <seginit>
  lapicinit();
...
80102e35:	e8 e6 36 00 00       	call   80106520 <seginit>
  picinit();       // disable pic
...
80102e55:	e8 a6 3f 00 00       	call   80106e00 <shminit>
  tvinit();        // trap vectors
...
801036f3:	e8 88 33 00 00       	call   80106a80 <setupkvm>
...
80103819:	e8 c2 30 00 00       	call   801068e0 <allocuvm>
...
8010384a:	e8 91 31 00 00       	call   801069e0 <deallocuvm>
...
8010388e:	e8 cd 32 00 00       	call   80106b60 <copyuvm>
...
801038ba:	89 42 7c             	mov    %eax,0x7c(%edx)
  np->tf->eax = 0;
801038bd:	8b 42 18             	mov    0x18(%edx),%eax
801038c0:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
801038c7:	90                   	nop
    if(curproc->ofile[i])
...
80103d48:	e8 b3 2c 00 00       	call   80106a00 <freevm>
        release(&ptable.lock);
...
80103e94:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103e98:	c7 04 24 27 79 10 80 	movl   $0x80107927,(%esp)
...
8010464d:	8b 14 85 80 75 10 80 	mov    -0x7fef8a80(,%eax,4),%edx
...
80104676:	c7 04 24 51 75 10 80 	movl   $0x80107551,(%esp)
...
80104800:	c7 44 24 04 fc 75 10 	movl   $0x801075fc,0x4(%esp)
80104807:	80 
...
8010481b:	c7 44 24 04 fb 75 10 	movl   $0x801075fb,0x4(%esp)
80104822:	80 
...
80104831:	79 89                	jns    801047bc <create+0xdc>
      panic("create dots");
80104833:	c7 04 24 ef 75 10 80 	movl   $0x801075ef,(%esp)
8010483a:	e8 21 bb ff ff       	call   80100360 <panic>
    panic("create: dirlink");
8010483f:	c7 04 24 fe 75 10 80 	movl   $0x801075fe,(%esp)
80104846:	e8 15 bb ff ff       	call   80100360 <panic>
    panic("create: ialloc");
8010484b:	c7 04 24 e0 75 10 80 	movl   $0x801075e0,(%esp)
...
80104bf1:	c7 44 24 04 fc 75 10 	movl   $0x801075fc,0x4(%esp)
80104bf8:	80 
...
80104c09:	c7 44 24 04 fb 75 10 	movl   $0x801075fb,0x4(%esp)
80104c10:	80 
...
80104d5d:	c7 04 24 20 76 10 80 	movl   $0x80107620,(%esp)
80104d64:	e8 f7 b5 ff ff       	call   80100360 <panic>
    panic("unlink: writei");
80104d69:	c7 04 24 32 76 10 80 	movl   $0x80107632,(%esp)
80104d70:	e8 eb b5 ff ff       	call   80100360 <panic>
    panic("unlink: nlink < 1");
80104d75:	c7 04 24 0e 76 10 80 	movl   $0x8010760e,(%esp)
...
80105229:	e8 32 1c 00 00       	call   80106e60 <shm_open>
}
8010522e:	c9                   	leave  
8010522f:	c3                   	ret    
    return -1;
...
80105263:	e8 08 1c 00 00       	call   80106e70 <shm_close>
}
80105268:	c9                   	leave  
80105269:	c3                   	ret    
...
801054a9:	c7 44 24 04 41 76 10 	movl   $0x80107641,0x4(%esp)
801054b0:	80 
...
80105532:	0f 84 10 02 00 00    	je     80105748 <trap+0x228>
    if(myproc()->killed)
      exit();
    return;
  }
...
80105540:	ff 24 85 a8 77 10 80 	jmp    *-0x7fef8858(,%eax,4)
80105547:	90                   	nop
...
80105548:	e8 63 e1 ff ff       	call   801036b0 <myproc>
8010554d:	85 c0                	test   %eax,%eax
8010554f:	90                   	nop
80105550:	0f 84 a8 02 00 00    	je     801057fe <trap+0x2de>
80105556:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
8010555a:	0f 84 9e 02 00 00    	je     801057fe <trap+0x2de>
...
8010556c:	e8 1f e1 ff ff       	call   80103690 <cpuid>
...
8010557c:	e8 2f e1 ff ff       	call   801036b0 <myproc>
...
801055b3:	c7 04 24 64 77 10 80 	movl   $0x80107764,(%esp)
...
801055d0:	e8 db e0 ff ff       	call   801036b0 <myproc>
801055d5:	85 c0                	test   %eax,%eax
801055d7:	74 0c                	je     801055e5 <trap+0xc5>
801055d9:	e8 d2 e0 ff ff       	call   801036b0 <myproc>
...
801055e5:	e8 c6 e0 ff ff       	call   801036b0 <myproc>
...
801055f9:	74 4d                	je     80105648 <trap+0x128>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801055fb:	e8 b0 e0 ff ff       	call   801036b0 <myproc>
80105600:	85 c0                	test   %eax,%eax
80105602:	74 1d                	je     80105621 <trap+0x101>
80105604:	e8 a7 e0 ff ff       	call   801036b0 <myproc>
...
8010561b:	0f 84 58 01 00 00    	je     80105779 <trap+0x259>
    exit();
}
...
8010563b:	75 a8                	jne    801055e5 <trap+0xc5>
    exit();
8010563d:	e8 6e e4 ff ff       	call   80103ab0 <exit>
...
80105650:	75 a9                	jne    801055fb <trap+0xdb>
    yield();
80105652:	e8 79 e5 ff ff       	call   80103bd0 <yield>
80105657:	eb a2                	jmp    801055fb <trap+0xdb>
80105659:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80105660:	0f 20 d6             	mov    %cr2,%esi
    if (fault2 > KERNBASE - 1) {
80105663:	85 f6                	test   %esi,%esi
80105665:	0f 88 7d 01 00 00    	js     801057e8 <trap+0x2c8>
8010566b:	90                   	nop
8010566c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if (allocuvm(myproc()->pgdir, fault2, fault2 + PGSIZE) == 0) {
80105670:	e8 3b e0 ff ff       	call   801036b0 <myproc>
    fault2 = PGROUNDDOWN(fault2);
80105675:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    if (allocuvm(myproc()->pgdir, fault2, fault2 + PGSIZE) == 0) {
8010567b:	8d 96 00 10 00 00    	lea    0x1000(%esi),%edx
80105681:	89 54 24 08          	mov    %edx,0x8(%esp)
80105685:	89 74 24 04          	mov    %esi,0x4(%esp)
80105689:	8b 40 04             	mov    0x4(%eax),%eax
8010568c:	89 04 24             	mov    %eax,(%esp)
8010568f:	e8 4c 12 00 00       	call   801068e0 <allocuvm>
80105694:	85 c0                	test   %eax,%eax
80105696:	0f 84 24 01 00 00    	je     801057c0 <trap+0x2a0>
    myproc()->stack_pages++;
8010569c:	e8 0f e0 ff ff       	call   801036b0 <myproc>
801056a1:	83 40 7c 01          	addl   $0x1,0x7c(%eax)
    cprintf("case T_PGFLT from trap.c: allocuvm succeeded. Number of pages allocated: %d\n", myproc()->stack_pages);
801056a5:	e8 06 e0 ff ff       	call   801036b0 <myproc>
801056aa:	8b 40 7c             	mov    0x7c(%eax),%eax
801056ad:	c7 04 24 e0 76 10 80 	movl   $0x801076e0,(%esp)
801056b4:	89 44 24 04          	mov    %eax,0x4(%esp)
801056b8:	e8 93 af ff ff       	call   80100650 <cprintf>
    break;
801056bd:	e9 0e ff ff ff       	jmp    801055d0 <trap+0xb0>
801056c2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(cpuid() == 0){
801056c8:	e8 c3 df ff ff       	call   80103690 <cpuid>
801056cd:	85 c0                	test   %eax,%eax
801056cf:	90                   	nop
801056d0:	0f 84 ba 00 00 00    	je     80105790 <trap+0x270>
    lapiceoi();
801056d6:	e8 b5 d0 ff ff       	call   80102790 <lapiceoi>
801056db:	90                   	nop
801056dc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    break;
801056e0:	e9 eb fe ff ff       	jmp    801055d0 <trap+0xb0>
...
801056f0:	e8 eb ce ff ff       	call   801025e0 <kbdintr>
    lapiceoi();
801056f5:	e8 96 d0 ff ff       	call   80102790 <lapiceoi>
    break;
801056fa:	e9 d1 fe ff ff       	jmp    801055d0 <trap+0xb0>
801056ff:	90                   	nop
    uartintr();
80105700:	e8 5b 02 00 00       	call   80105960 <uartintr>
    lapiceoi();
80105705:	e8 86 d0 ff ff       	call   80102790 <lapiceoi>
    break;
8010570a:	e9 c1 fe ff ff       	jmp    801055d0 <trap+0xb0>
8010570f:	90                   	nop
...
8010571c:	c7 04 24 68 76 10 80 	movl   $0x80107668,(%esp)
...
8010572f:	e8 1c af ff ff       	call   80100650 <cprintf>
    lapiceoi();
80105734:	e8 57 d0 ff ff       	call   80102790 <lapiceoi>
    break;
80105739:	e9 92 fe ff ff       	jmp    801055d0 <trap+0xb0>
8010573e:	66 90                	xchg   %ax,%ax
    ideintr();
80105740:	e8 4b c9 ff ff       	call   80102090 <ideintr>
80105745:	eb 8f                	jmp    801056d6 <trap+0x1b6>
80105747:	90                   	nop
80105748:	90                   	nop
...
8010575a:	75 2c                	jne    80105788 <trap+0x268>
    myproc()->tf = tf;
8010575c:	e8 4f df ff ff       	call   801036b0 <myproc>
80105761:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105764:	e8 c7 ee ff ff       	call   80104630 <syscall>
    if(myproc()->killed)
80105769:	e8 42 df ff ff       	call   801036b0 <myproc>
8010576e:	8b 48 24             	mov    0x24(%eax),%ecx
80105771:	85 c9                	test   %ecx,%ecx
80105773:	0f 84 a8 fe ff ff    	je     80105621 <trap+0x101>
}
...
8010577f:	5d                   	pop    %ebp
      exit();
80105780:	e9 2b e3 ff ff       	jmp    80103ab0 <exit>
80105785:	8d 76 00             	lea    0x0(%esi),%esi
      exit();
80105788:	e8 23 e3 ff ff       	call   80103ab0 <exit>
8010578d:	eb cd                	jmp    8010575c <trap+0x23c>
8010578f:	90                   	nop
      acquire(&tickslock);
80105790:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105797:	e8 b4 e9 ff ff       	call   80104150 <acquire>
      wakeup(&ticks);
8010579c:	c7 04 24 a0 55 11 80 	movl   $0x801155a0,(%esp)
      ticks++;
801057a3:	83 05 a0 55 11 80 01 	addl   $0x1,0x801155a0
      wakeup(&ticks);
801057aa:	e8 f1 e5 ff ff       	call   80103da0 <wakeup>
      release(&tickslock);
801057af:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
801057b6:	e8 85 ea ff ff       	call   80104240 <release>
801057bb:	e9 16 ff ff ff       	jmp    801056d6 <trap+0x1b6>
      cprintf("case T_PGFLT from trap.c: allocuvm failed. Number of current allocated pages: %d\n", myproc()->stack_pages);
801057c0:	e8 eb de ff ff       	call   801036b0 <myproc>
801057c5:	8b 40 7c             	mov    0x7c(%eax),%eax
801057c8:	c7 04 24 8c 76 10 80 	movl   $0x8010768c,(%esp)
801057cf:	89 44 24 04          	mov    %eax,0x4(%esp)
801057d3:	e8 78 ae ff ff       	call   80100650 <cprintf>
      exit();
801057d8:	e8 d3 e2 ff ff       	call   80103ab0 <exit>
801057dd:	e9 ba fe ff ff       	jmp    8010569c <trap+0x17c>
801057e2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      cprintf("from trap access > KERNBASE");
801057e8:	c7 04 24 46 76 10 80 	movl   $0x80107646,(%esp)
801057ef:	e8 5c ae ff ff       	call   80100650 <cprintf>
      exit();
801057f4:	e8 b7 e2 ff ff       	call   80103ab0 <exit>
801057f9:	e9 6d fe ff ff       	jmp    8010566b <trap+0x14b>
801057fe:	0f 20 d7             	mov    %cr2,%edi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105801:	8b 73 38             	mov    0x38(%ebx),%esi
80105804:	e8 87 de ff ff       	call   80103690 <cpuid>
80105809:	89 7c 24 10          	mov    %edi,0x10(%esp)
8010580d:	89 74 24 0c          	mov    %esi,0xc(%esp)
80105811:	89 44 24 08          	mov    %eax,0x8(%esp)
80105815:	8b 43 30             	mov    0x30(%ebx),%eax
80105818:	c7 04 24 30 77 10 80 	movl   $0x80107730,(%esp)
8010581f:	89 44 24 04          	mov    %eax,0x4(%esp)
80105823:	e8 28 ae ff ff       	call   80100650 <cprintf>
      panic("trap");
80105828:	c7 04 24 62 76 10 80 	movl   $0x80107662,(%esp)
8010582f:	e8 2c ab ff ff       	call   80100360 <panic>
80105834:	66 90                	xchg   %ax,%ax
...
80105927:	00 
  for(p="xv6...\n"; *p; p++)
80105928:	bb 70 78 10 80       	mov    $0x80107870,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80105976:	6a 00                	push   $0x0
  jmp alltraps
80105978:	e9 b0 fa ff ff       	jmp    8010542d <alltraps>
...
8010597f:	6a 01                	push   $0x1
  jmp alltraps
80105981:	e9 a7 fa ff ff       	jmp    8010542d <alltraps>
...
80105988:	6a 02                	push   $0x2
  jmp alltraps
8010598a:	e9 9e fa ff ff       	jmp    8010542d <alltraps>
...
8010599a:	6a 04                	push   $0x4
  jmp alltraps
8010599c:	e9 8c fa ff ff       	jmp    8010542d <alltraps>
...
801059a3:	6a 05                	push   $0x5
  jmp alltraps
801059a5:	e9 83 fa ff ff       	jmp    8010542d <alltraps>
...
801059b5:	6a 07                	push   $0x7
  jmp alltraps
801059b7:	e9 71 fa ff ff       	jmp    8010542d <alltraps>
...
801059bc:	6a 08                	push   $0x8
  jmp alltraps
801059be:	e9 6a fa ff ff       	jmp    8010542d <alltraps>
...
801059c5:	6a 09                	push   $0x9
  jmp alltraps
801059c7:	e9 61 fa ff ff       	jmp    8010542d <alltraps>
...
801059d3:	6a 0b                	push   $0xb
  jmp alltraps
801059d5:	e9 53 fa ff ff       	jmp    8010542d <alltraps>
...
801059e8:	6a 0e                	push   $0xe
  jmp alltraps
801059ea:	e9 3e fa ff ff       	jmp    8010542d <alltraps>
...
801059f1:	6a 0f                	push   $0xf
  jmp alltraps
801059f3:	e9 35 fa ff ff       	jmp    8010542d <alltraps>
...
801059fa:	6a 10                	push   $0x10
  jmp alltraps
801059fc:	e9 2c fa ff ff       	jmp    8010542d <alltraps>
...
80105a01:	6a 11                	push   $0x11
  jmp alltraps
80105a03:	e9 25 fa ff ff       	jmp    8010542d <alltraps>
...
80105a0a:	6a 12                	push   $0x12
  jmp alltraps
80105a0c:	e9 1c fa ff ff       	jmp    8010542d <alltraps>
...
80105a13:	6a 13                	push   $0x13
  jmp alltraps
80105a15:	e9 13 fa ff ff       	jmp    8010542d <alltraps>
...
80105a1c:	6a 14                	push   $0x14
  jmp alltraps
80105a1e:	e9 0a fa ff ff       	jmp    8010542d <alltraps>
...
80105a25:	6a 15                	push   $0x15
  jmp alltraps
80105a27:	e9 01 fa ff ff       	jmp    8010542d <alltraps>
...
80105a2e:	6a 16                	push   $0x16
  jmp alltraps
80105a30:	e9 f8 f9 ff ff       	jmp    8010542d <alltraps>
...
80105a37:	6a 17                	push   $0x17
  jmp alltraps
80105a39:	e9 ef f9 ff ff       	jmp    8010542d <alltraps>
...
80105a40:	6a 18                	push   $0x18
  jmp alltraps
80105a42:	e9 e6 f9 ff ff       	jmp    8010542d <alltraps>
...
80105a49:	6a 19                	push   $0x19
  jmp alltraps
80105a4b:	e9 dd f9 ff ff       	jmp    8010542d <alltraps>
...
80105a52:	6a 1a                	push   $0x1a
  jmp alltraps
80105a54:	e9 d4 f9 ff ff       	jmp    8010542d <alltraps>
...
80105a5b:	6a 1b                	push   $0x1b
  jmp alltraps
80105a5d:	e9 cb f9 ff ff       	jmp    8010542d <alltraps>
...
80105a64:	6a 1c                	push   $0x1c
  jmp alltraps
80105a66:	e9 c2 f9 ff ff       	jmp    8010542d <alltraps>
...
80105a6d:	6a 1d                	push   $0x1d
  jmp alltraps
80105a6f:	e9 b9 f9 ff ff       	jmp    8010542d <alltraps>
...
80105a76:	6a 1e                	push   $0x1e
  jmp alltraps
80105a78:	e9 b0 f9 ff ff       	jmp    8010542d <alltraps>
...
80105a7f:	6a 1f                	push   $0x1f
  jmp alltraps
80105a81:	e9 a7 f9 ff ff       	jmp    8010542d <alltraps>
...
80105a88:	6a 20                	push   $0x20
  jmp alltraps
80105a8a:	e9 9e f9 ff ff       	jmp    8010542d <alltraps>
...
80105a91:	6a 21                	push   $0x21
  jmp alltraps
80105a93:	e9 95 f9 ff ff       	jmp    8010542d <alltraps>
...
80105a9a:	6a 22                	push   $0x22
  jmp alltraps
80105a9c:	e9 8c f9 ff ff       	jmp    8010542d <alltraps>
...
80105aa3:	6a 23                	push   $0x23
  jmp alltraps
80105aa5:	e9 83 f9 ff ff       	jmp    8010542d <alltraps>
...
80105aac:	6a 24                	push   $0x24
  jmp alltraps
80105aae:	e9 7a f9 ff ff       	jmp    8010542d <alltraps>
...
80105ab5:	6a 25                	push   $0x25
  jmp alltraps
80105ab7:	e9 71 f9 ff ff       	jmp    8010542d <alltraps>
...
80105abe:	6a 26                	push   $0x26
  jmp alltraps
80105ac0:	e9 68 f9 ff ff       	jmp    8010542d <alltraps>
...
80105ac7:	6a 27                	push   $0x27
  jmp alltraps
80105ac9:	e9 5f f9 ff ff       	jmp    8010542d <alltraps>
...
80105ad0:	6a 28                	push   $0x28
  jmp alltraps
80105ad2:	e9 56 f9 ff ff       	jmp    8010542d <alltraps>
...
80105ad9:	6a 29                	push   $0x29
  jmp alltraps
80105adb:	e9 4d f9 ff ff       	jmp    8010542d <alltraps>
...
80105ae2:	6a 2a                	push   $0x2a
  jmp alltraps
80105ae4:	e9 44 f9 ff ff       	jmp    8010542d <alltraps>
...
80105aeb:	6a 2b                	push   $0x2b
  jmp alltraps
80105aed:	e9 3b f9 ff ff       	jmp    8010542d <alltraps>
...
80105af4:	6a 2c                	push   $0x2c
  jmp alltraps
80105af6:	e9 32 f9 ff ff       	jmp    8010542d <alltraps>
...
80105afd:	6a 2d                	push   $0x2d
  jmp alltraps
80105aff:	e9 29 f9 ff ff       	jmp    8010542d <alltraps>
...
80105b06:	6a 2e                	push   $0x2e
  jmp alltraps
80105b08:	e9 20 f9 ff ff       	jmp    8010542d <alltraps>
...
80105b0f:	6a 2f                	push   $0x2f
  jmp alltraps
80105b11:	e9 17 f9 ff ff       	jmp    8010542d <alltraps>
...
80105b18:	6a 30                	push   $0x30
  jmp alltraps
80105b1a:	e9 0e f9 ff ff       	jmp    8010542d <alltraps>
...
80105b21:	6a 31                	push   $0x31
  jmp alltraps
80105b23:	e9 05 f9 ff ff       	jmp    8010542d <alltraps>
...
80105b2a:	6a 32                	push   $0x32
  jmp alltraps
80105b2c:	e9 fc f8 ff ff       	jmp    8010542d <alltraps>
...
80105b33:	6a 33                	push   $0x33
  jmp alltraps
80105b35:	e9 f3 f8 ff ff       	jmp    8010542d <alltraps>
...
80105b3c:	6a 34                	push   $0x34
  jmp alltraps
80105b3e:	e9 ea f8 ff ff       	jmp    8010542d <alltraps>
...
80105b45:	6a 35                	push   $0x35
  jmp alltraps
80105b47:	e9 e1 f8 ff ff       	jmp    8010542d <alltraps>
...
80105b4e:	6a 36                	push   $0x36
  jmp alltraps
80105b50:	e9 d8 f8 ff ff       	jmp    8010542d <alltraps>
...
80105b57:	6a 37                	push   $0x37
  jmp alltraps
80105b59:	e9 cf f8 ff ff       	jmp    8010542d <alltraps>
...
80105b60:	6a 38                	push   $0x38
  jmp alltraps
80105b62:	e9 c6 f8 ff ff       	jmp    8010542d <alltraps>
...
80105b69:	6a 39                	push   $0x39
  jmp alltraps
80105b6b:	e9 bd f8 ff ff       	jmp    8010542d <alltraps>
...
80105b72:	6a 3a                	push   $0x3a
  jmp alltraps
80105b74:	e9 b4 f8 ff ff       	jmp    8010542d <alltraps>
...
80105b7b:	6a 3b                	push   $0x3b
  jmp alltraps
80105b7d:	e9 ab f8 ff ff       	jmp    8010542d <alltraps>
...
80105b84:	6a 3c                	push   $0x3c
  jmp alltraps
80105b86:	e9 a2 f8 ff ff       	jmp    8010542d <alltraps>
...
80105b8d:	6a 3d                	push   $0x3d
  jmp alltraps
80105b8f:	e9 99 f8 ff ff       	jmp    8010542d <alltraps>
...
80105b96:	6a 3e                	push   $0x3e
  jmp alltraps
80105b98:	e9 90 f8 ff ff       	jmp    8010542d <alltraps>
...
80105b9f:	6a 3f                	push   $0x3f
  jmp alltraps
80105ba1:	e9 87 f8 ff ff       	jmp    8010542d <alltraps>
...
80105ba8:	6a 40                	push   $0x40
  jmp alltraps
80105baa:	e9 7e f8 ff ff       	jmp    8010542d <alltraps>
...
80105bb1:	6a 41                	push   $0x41
  jmp alltraps
80105bb3:	e9 75 f8 ff ff       	jmp    8010542d <alltraps>
...
80105bba:	6a 42                	push   $0x42
  jmp alltraps
80105bbc:	e9 6c f8 ff ff       	jmp    8010542d <alltraps>
...
80105bc3:	6a 43                	push   $0x43
  jmp alltraps
80105bc5:	e9 63 f8 ff ff       	jmp    8010542d <alltraps>
...
80105bcc:	6a 44                	push   $0x44
  jmp alltraps
80105bce:	e9 5a f8 ff ff       	jmp    8010542d <alltraps>
...
80105bd5:	6a 45                	push   $0x45
  jmp alltraps
80105bd7:	e9 51 f8 ff ff       	jmp    8010542d <alltraps>
...
80105bde:	6a 46                	push   $0x46
  jmp alltraps
80105be0:	e9 48 f8 ff ff       	jmp    8010542d <alltraps>
...
80105be7:	6a 47                	push   $0x47
  jmp alltraps
80105be9:	e9 3f f8 ff ff       	jmp    8010542d <alltraps>
...
80105bf0:	6a 48                	push   $0x48
  jmp alltraps
80105bf2:	e9 36 f8 ff ff       	jmp    8010542d <alltraps>
...
80105bf9:	6a 49                	push   $0x49
  jmp alltraps
80105bfb:	e9 2d f8 ff ff       	jmp    8010542d <alltraps>
...
80105c02:	6a 4a                	push   $0x4a
  jmp alltraps
80105c04:	e9 24 f8 ff ff       	jmp    8010542d <alltraps>
...
80105c0b:	6a 4b                	push   $0x4b
  jmp alltraps
80105c0d:	e9 1b f8 ff ff       	jmp    8010542d <alltraps>
...
80105c14:	6a 4c                	push   $0x4c
  jmp alltraps
80105c16:	e9 12 f8 ff ff       	jmp    8010542d <alltraps>
...
80105c1d:	6a 4d                	push   $0x4d
  jmp alltraps
80105c1f:	e9 09 f8 ff ff       	jmp    8010542d <alltraps>
...
80105c26:	6a 4e                	push   $0x4e
  jmp alltraps
80105c28:	e9 00 f8 ff ff       	jmp    8010542d <alltraps>
...
80105c2f:	6a 4f                	push   $0x4f
  jmp alltraps
80105c31:	e9 f7 f7 ff ff       	jmp    8010542d <alltraps>
...
80105c38:	6a 50                	push   $0x50
  jmp alltraps
80105c3a:	e9 ee f7 ff ff       	jmp    8010542d <alltraps>
...
80105c41:	6a 51                	push   $0x51
  jmp alltraps
80105c43:	e9 e5 f7 ff ff       	jmp    8010542d <alltraps>
...
80105c4a:	6a 52                	push   $0x52
  jmp alltraps
80105c4c:	e9 dc f7 ff ff       	jmp    8010542d <alltraps>
...
80105c53:	6a 53                	push   $0x53
  jmp alltraps
80105c55:	e9 d3 f7 ff ff       	jmp    8010542d <alltraps>
...
80105c5c:	6a 54                	push   $0x54
  jmp alltraps
80105c5e:	e9 ca f7 ff ff       	jmp    8010542d <alltraps>
...
80105c65:	6a 55                	push   $0x55
  jmp alltraps
80105c67:	e9 c1 f7 ff ff       	jmp    8010542d <alltraps>
...
80105c6e:	6a 56                	push   $0x56
  jmp alltraps
80105c70:	e9 b8 f7 ff ff       	jmp    8010542d <alltraps>
...
80105c77:	6a 57                	push   $0x57
  jmp alltraps
80105c79:	e9 af f7 ff ff       	jmp    8010542d <alltraps>
...
80105c80:	6a 58                	push   $0x58
  jmp alltraps
80105c82:	e9 a6 f7 ff ff       	jmp    8010542d <alltraps>
...
80105c89:	6a 59                	push   $0x59
  jmp alltraps
80105c8b:	e9 9d f7 ff ff       	jmp    8010542d <alltraps>
...
80105c92:	6a 5a                	push   $0x5a
  jmp alltraps
80105c94:	e9 94 f7 ff ff       	jmp    8010542d <alltraps>
...
80105c9b:	6a 5b                	push   $0x5b
  jmp alltraps
80105c9d:	e9 8b f7 ff ff       	jmp    8010542d <alltraps>
...
80105ca4:	6a 5c                	push   $0x5c
  jmp alltraps
80105ca6:	e9 82 f7 ff ff       	jmp    8010542d <alltraps>
...
80105cad:	6a 5d                	push   $0x5d
  jmp alltraps
80105caf:	e9 79 f7 ff ff       	jmp    8010542d <alltraps>
...
80105cb6:	6a 5e                	push   $0x5e
  jmp alltraps
80105cb8:	e9 70 f7 ff ff       	jmp    8010542d <alltraps>
...
80105cbf:	6a 5f                	push   $0x5f
  jmp alltraps
80105cc1:	e9 67 f7 ff ff       	jmp    8010542d <alltraps>
...
80105cc8:	6a 60                	push   $0x60
  jmp alltraps
80105cca:	e9 5e f7 ff ff       	jmp    8010542d <alltraps>
...
80105cd1:	6a 61                	push   $0x61
  jmp alltraps
80105cd3:	e9 55 f7 ff ff       	jmp    8010542d <alltraps>
...
80105cda:	6a 62                	push   $0x62
  jmp alltraps
80105cdc:	e9 4c f7 ff ff       	jmp    8010542d <alltraps>
...
80105ce3:	6a 63                	push   $0x63
  jmp alltraps
80105ce5:	e9 43 f7 ff ff       	jmp    8010542d <alltraps>
...
80105cec:	6a 64                	push   $0x64
  jmp alltraps
80105cee:	e9 3a f7 ff ff       	jmp    8010542d <alltraps>
...
80105cf5:	6a 65                	push   $0x65
  jmp alltraps
80105cf7:	e9 31 f7 ff ff       	jmp    8010542d <alltraps>
...
80105cfe:	6a 66                	push   $0x66
  jmp alltraps
80105d00:	e9 28 f7 ff ff       	jmp    8010542d <alltraps>
...
80105d07:	6a 67                	push   $0x67
  jmp alltraps
80105d09:	e9 1f f7 ff ff       	jmp    8010542d <alltraps>
...
80105d10:	6a 68                	push   $0x68
  jmp alltraps
80105d12:	e9 16 f7 ff ff       	jmp    8010542d <alltraps>
...
80105d19:	6a 69                	push   $0x69
  jmp alltraps
80105d1b:	e9 0d f7 ff ff       	jmp    8010542d <alltraps>
...
80105d22:	6a 6a                	push   $0x6a
  jmp alltraps
80105d24:	e9 04 f7 ff ff       	jmp    8010542d <alltraps>
...
80105d2b:	6a 6b                	push   $0x6b
  jmp alltraps
80105d2d:	e9 fb f6 ff ff       	jmp    8010542d <alltraps>
...
80105d34:	6a 6c                	push   $0x6c
  jmp alltraps
80105d36:	e9 f2 f6 ff ff       	jmp    8010542d <alltraps>
...
80105d3d:	6a 6d                	push   $0x6d
  jmp alltraps
80105d3f:	e9 e9 f6 ff ff       	jmp    8010542d <alltraps>
...
80105d46:	6a 6e                	push   $0x6e
  jmp alltraps
80105d48:	e9 e0 f6 ff ff       	jmp    8010542d <alltraps>
...
80105d4f:	6a 6f                	push   $0x6f
  jmp alltraps
80105d51:	e9 d7 f6 ff ff       	jmp    8010542d <alltraps>
...
80105d58:	6a 70                	push   $0x70
  jmp alltraps
80105d5a:	e9 ce f6 ff ff       	jmp    8010542d <alltraps>
...
80105d61:	6a 71                	push   $0x71
  jmp alltraps
80105d63:	e9 c5 f6 ff ff       	jmp    8010542d <alltraps>
...
80105d6a:	6a 72                	push   $0x72
  jmp alltraps
80105d6c:	e9 bc f6 ff ff       	jmp    8010542d <alltraps>
...
80105d73:	6a 73                	push   $0x73
  jmp alltraps
80105d75:	e9 b3 f6 ff ff       	jmp    8010542d <alltraps>
...
80105d7c:	6a 74                	push   $0x74
  jmp alltraps
80105d7e:	e9 aa f6 ff ff       	jmp    8010542d <alltraps>
...
80105d85:	6a 75                	push   $0x75
  jmp alltraps
80105d87:	e9 a1 f6 ff ff       	jmp    8010542d <alltraps>
...
80105d8e:	6a 76                	push   $0x76
  jmp alltraps
80105d90:	e9 98 f6 ff ff       	jmp    8010542d <alltraps>
...
80105d97:	6a 77                	push   $0x77
  jmp alltraps
80105d99:	e9 8f f6 ff ff       	jmp    8010542d <alltraps>
...
80105da0:	6a 78                	push   $0x78
  jmp alltraps
80105da2:	e9 86 f6 ff ff       	jmp    8010542d <alltraps>
...
80105da9:	6a 79                	push   $0x79
  jmp alltraps
80105dab:	e9 7d f6 ff ff       	jmp    8010542d <alltraps>
...
80105db2:	6a 7a                	push   $0x7a
  jmp alltraps
80105db4:	e9 74 f6 ff ff       	jmp    8010542d <alltraps>
...
80105dbb:	6a 7b                	push   $0x7b
  jmp alltraps
80105dbd:	e9 6b f6 ff ff       	jmp    8010542d <alltraps>
...
80105dc4:	6a 7c                	push   $0x7c
  jmp alltraps
80105dc6:	e9 62 f6 ff ff       	jmp    8010542d <alltraps>
...
80105dcd:	6a 7d                	push   $0x7d
  jmp alltraps
80105dcf:	e9 59 f6 ff ff       	jmp    8010542d <alltraps>
...
80105dd6:	6a 7e                	push   $0x7e
  jmp alltraps
80105dd8:	e9 50 f6 ff ff       	jmp    8010542d <alltraps>
...
80105ddf:	6a 7f                	push   $0x7f
  jmp alltraps
80105de1:	e9 47 f6 ff ff       	jmp    8010542d <alltraps>
...
80105de8:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105ded:	e9 3b f6 ff ff       	jmp    8010542d <alltraps>
...
80105df4:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80105df9:	e9 2f f6 ff ff       	jmp    8010542d <alltraps>
...
80105e00:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80105e05:	e9 23 f6 ff ff       	jmp    8010542d <alltraps>
...
80105e0c:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80105e11:	e9 17 f6 ff ff       	jmp    8010542d <alltraps>
...
80105e18:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80105e1d:	e9 0b f6 ff ff       	jmp    8010542d <alltraps>
...
80105e24:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80105e29:	e9 ff f5 ff ff       	jmp    8010542d <alltraps>
...
80105e30:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80105e35:	e9 f3 f5 ff ff       	jmp    8010542d <alltraps>
...
80105e3c:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80105e41:	e9 e7 f5 ff ff       	jmp    8010542d <alltraps>
...
80105e48:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80105e4d:	e9 db f5 ff ff       	jmp    8010542d <alltraps>
...
80105e54:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80105e59:	e9 cf f5 ff ff       	jmp    8010542d <alltraps>
...
80105e60:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80105e65:	e9 c3 f5 ff ff       	jmp    8010542d <alltraps>
...
80105e6c:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80105e71:	e9 b7 f5 ff ff       	jmp    8010542d <alltraps>
...
80105e78:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80105e7d:	e9 ab f5 ff ff       	jmp    8010542d <alltraps>
...
80105e84:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80105e89:	e9 9f f5 ff ff       	jmp    8010542d <alltraps>
...
80105e90:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80105e95:	e9 93 f5 ff ff       	jmp    8010542d <alltraps>
...
80105e9c:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80105ea1:	e9 87 f5 ff ff       	jmp    8010542d <alltraps>
...
80105ea8:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80105ead:	e9 7b f5 ff ff       	jmp    8010542d <alltraps>
...
80105eb4:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80105eb9:	e9 6f f5 ff ff       	jmp    8010542d <alltraps>
...
80105ec0:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80105ec5:	e9 63 f5 ff ff       	jmp    8010542d <alltraps>
...
80105ecc:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80105ed1:	e9 57 f5 ff ff       	jmp    8010542d <alltraps>
...
80105ed8:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80105edd:	e9 4b f5 ff ff       	jmp    8010542d <alltraps>
...
80105ee4:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80105ee9:	e9 3f f5 ff ff       	jmp    8010542d <alltraps>
...
80105ef0:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80105ef5:	e9 33 f5 ff ff       	jmp    8010542d <alltraps>
...
80105efc:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80105f01:	e9 27 f5 ff ff       	jmp    8010542d <alltraps>
...
80105f08:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80105f0d:	e9 1b f5 ff ff       	jmp    8010542d <alltraps>
...
80105f14:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80105f19:	e9 0f f5 ff ff       	jmp    8010542d <alltraps>
...
80105f20:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80105f25:	e9 03 f5 ff ff       	jmp    8010542d <alltraps>
...
80105f2c:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80105f31:	e9 f7 f4 ff ff       	jmp    8010542d <alltraps>
...
80105f38:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80105f3d:	e9 eb f4 ff ff       	jmp    8010542d <alltraps>
...
80105f44:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80105f49:	e9 df f4 ff ff       	jmp    8010542d <alltraps>
...
80105f50:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80105f55:	e9 d3 f4 ff ff       	jmp    8010542d <alltraps>
...
80105f5c:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80105f61:	e9 c7 f4 ff ff       	jmp    8010542d <alltraps>
...
80105f68:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80105f6d:	e9 bb f4 ff ff       	jmp    8010542d <alltraps>
...
80105f74:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80105f79:	e9 af f4 ff ff       	jmp    8010542d <alltraps>
...
80105f80:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80105f85:	e9 a3 f4 ff ff       	jmp    8010542d <alltraps>
...
80105f8c:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80105f91:	e9 97 f4 ff ff       	jmp    8010542d <alltraps>
...
80105f98:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80105f9d:	e9 8b f4 ff ff       	jmp    8010542d <alltraps>
...
80105fa4:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80105fa9:	e9 7f f4 ff ff       	jmp    8010542d <alltraps>
...
80105fb0:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80105fb5:	e9 73 f4 ff ff       	jmp    8010542d <alltraps>
...
80105fbc:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80105fc1:	e9 67 f4 ff ff       	jmp    8010542d <alltraps>
...
80105fc8:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80105fcd:	e9 5b f4 ff ff       	jmp    8010542d <alltraps>
...
80105fd4:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80105fd9:	e9 4f f4 ff ff       	jmp    8010542d <alltraps>
...
80105fe0:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80105fe5:	e9 43 f4 ff ff       	jmp    8010542d <alltraps>
...
80105fec:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80105ff1:	e9 37 f4 ff ff       	jmp    8010542d <alltraps>
...
80105ff8:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80105ffd:	e9 2b f4 ff ff       	jmp    8010542d <alltraps>
...
80106004:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80106009:	e9 1f f4 ff ff       	jmp    8010542d <alltraps>
...
80106010:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106015:	e9 13 f4 ff ff       	jmp    8010542d <alltraps>
...
8010601c:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106021:	e9 07 f4 ff ff       	jmp    8010542d <alltraps>
...
80106028:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010602d:	e9 fb f3 ff ff       	jmp    8010542d <alltraps>
...
80106034:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80106039:	e9 ef f3 ff ff       	jmp    8010542d <alltraps>
...
80106040:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106045:	e9 e3 f3 ff ff       	jmp    8010542d <alltraps>
...
8010604c:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106051:	e9 d7 f3 ff ff       	jmp    8010542d <alltraps>
...
80106058:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010605d:	e9 cb f3 ff ff       	jmp    8010542d <alltraps>
...
80106064:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80106069:	e9 bf f3 ff ff       	jmp    8010542d <alltraps>
...
80106070:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106075:	e9 b3 f3 ff ff       	jmp    8010542d <alltraps>
...
8010607c:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106081:	e9 a7 f3 ff ff       	jmp    8010542d <alltraps>
...
80106088:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010608d:	e9 9b f3 ff ff       	jmp    8010542d <alltraps>
...
80106094:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80106099:	e9 8f f3 ff ff       	jmp    8010542d <alltraps>
...
801060a0:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801060a5:	e9 83 f3 ff ff       	jmp    8010542d <alltraps>
...
801060ac:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801060b1:	e9 77 f3 ff ff       	jmp    8010542d <alltraps>
...
801060b8:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801060bd:	e9 6b f3 ff ff       	jmp    8010542d <alltraps>
...
801060c4:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801060c9:	e9 5f f3 ff ff       	jmp    8010542d <alltraps>
...
801060d0:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801060d5:	e9 53 f3 ff ff       	jmp    8010542d <alltraps>
...
801060dc:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801060e1:	e9 47 f3 ff ff       	jmp    8010542d <alltraps>
...
801060e8:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801060ed:	e9 3b f3 ff ff       	jmp    8010542d <alltraps>
...
801060f4:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801060f9:	e9 2f f3 ff ff       	jmp    8010542d <alltraps>
...
80106100:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106105:	e9 23 f3 ff ff       	jmp    8010542d <alltraps>
...
8010610c:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106111:	e9 17 f3 ff ff       	jmp    8010542d <alltraps>
...
80106118:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010611d:	e9 0b f3 ff ff       	jmp    8010542d <alltraps>
...
80106124:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80106129:	e9 ff f2 ff ff       	jmp    8010542d <alltraps>
...
80106130:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106135:	e9 f3 f2 ff ff       	jmp    8010542d <alltraps>
...
8010613c:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106141:	e9 e7 f2 ff ff       	jmp    8010542d <alltraps>
...
80106148:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010614d:	e9 db f2 ff ff       	jmp    8010542d <alltraps>
...
80106154:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80106159:	e9 cf f2 ff ff       	jmp    8010542d <alltraps>
...
80106160:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106165:	e9 c3 f2 ff ff       	jmp    8010542d <alltraps>
...
8010616c:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106171:	e9 b7 f2 ff ff       	jmp    8010542d <alltraps>
...
80106178:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010617d:	e9 ab f2 ff ff       	jmp    8010542d <alltraps>
...
80106184:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80106189:	e9 9f f2 ff ff       	jmp    8010542d <alltraps>
...
80106190:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106195:	e9 93 f2 ff ff       	jmp    8010542d <alltraps>
...
8010619c:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801061a1:	e9 87 f2 ff ff       	jmp    8010542d <alltraps>
...
801061a8:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801061ad:	e9 7b f2 ff ff       	jmp    8010542d <alltraps>
...
801061b4:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801061b9:	e9 6f f2 ff ff       	jmp    8010542d <alltraps>
...
801061c0:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801061c5:	e9 63 f2 ff ff       	jmp    8010542d <alltraps>
...
801061cc:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801061d1:	e9 57 f2 ff ff       	jmp    8010542d <alltraps>
...
801061d8:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801061dd:	e9 4b f2 ff ff       	jmp    8010542d <alltraps>
...
801061e4:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801061e9:	e9 3f f2 ff ff       	jmp    8010542d <alltraps>
...
801061f0:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801061f5:	e9 33 f2 ff ff       	jmp    8010542d <alltraps>
...
801061fc:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106201:	e9 27 f2 ff ff       	jmp    8010542d <alltraps>
...
80106208:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010620d:	e9 1b f2 ff ff       	jmp    8010542d <alltraps>
...
80106214:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80106219:	e9 0f f2 ff ff       	jmp    8010542d <alltraps>
...
80106220:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106225:	e9 03 f2 ff ff       	jmp    8010542d <alltraps>
...
8010622c:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106231:	e9 f7 f1 ff ff       	jmp    8010542d <alltraps>
...
80106238:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010623d:	e9 eb f1 ff ff       	jmp    8010542d <alltraps>
...
80106244:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106249:	e9 df f1 ff ff       	jmp    8010542d <alltraps>
...
80106250:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106255:	e9 d3 f1 ff ff       	jmp    8010542d <alltraps>
...
8010625c:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106261:	e9 c7 f1 ff ff       	jmp    8010542d <alltraps>
...
80106268:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010626d:	e9 bb f1 ff ff       	jmp    8010542d <alltraps>
...
80106274:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80106279:	e9 af f1 ff ff       	jmp    8010542d <alltraps>
...
80106280:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106285:	e9 a3 f1 ff ff       	jmp    8010542d <alltraps>
...
8010628c:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106291:	e9 97 f1 ff ff       	jmp    8010542d <alltraps>
...
80106298:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010629d:	e9 8b f1 ff ff       	jmp    8010542d <alltraps>
...
801062a4:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801062a9:	e9 7f f1 ff ff       	jmp    8010542d <alltraps>
...
801062b0:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801062b5:	e9 73 f1 ff ff       	jmp    8010542d <alltraps>
...
801062bc:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801062c1:	e9 67 f1 ff ff       	jmp    8010542d <alltraps>
...
801062c8:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801062cd:	e9 5b f1 ff ff       	jmp    8010542d <alltraps>
...
801062d4:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801062d9:	e9 4f f1 ff ff       	jmp    8010542d <alltraps>
...
801062e0:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801062e5:	e9 43 f1 ff ff       	jmp    8010542d <alltraps>
...
801062ec:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801062f1:	e9 37 f1 ff ff       	jmp    8010542d <alltraps>
...
801062f8:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801062fd:	e9 2b f1 ff ff       	jmp    8010542d <alltraps>
...
80106304:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106309:	e9 1f f1 ff ff       	jmp    8010542d <alltraps>
...
80106310:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106315:	e9 13 f1 ff ff       	jmp    8010542d <alltraps>
...
8010631c:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106321:	e9 07 f1 ff ff       	jmp    8010542d <alltraps>
...
80106328:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010632d:	e9 fb f0 ff ff       	jmp    8010542d <alltraps>
...
80106334:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106339:	e9 ef f0 ff ff       	jmp    8010542d <alltraps>
...
80106340:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106345:	e9 e3 f0 ff ff       	jmp    8010542d <alltraps>
...
8010634c:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106351:	e9 d7 f0 ff ff       	jmp    8010542d <alltraps>
...
80106358:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010635d:	e9 cb f0 ff ff       	jmp    8010542d <alltraps>
...
80106364:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106369:	e9 bf f0 ff ff       	jmp    8010542d <alltraps>
...
80106370:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106375:	e9 b3 f0 ff ff       	jmp    8010542d <alltraps>
...
8010637c:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106381:	e9 a7 f0 ff ff       	jmp    8010542d <alltraps>
...
80106388:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010638d:	e9 9b f0 ff ff       	jmp    8010542d <alltraps>
...
80106394:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106399:	e9 8f f0 ff ff       	jmp    8010542d <alltraps>
...
801063a0:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801063a5:	e9 83 f0 ff ff       	jmp    8010542d <alltraps>
...
801063ac:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801063b1:	e9 77 f0 ff ff       	jmp    8010542d <alltraps>
...
801063b8:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801063bd:	e9 6b f0 ff ff       	jmp    8010542d <alltraps>
...
801063c4:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801063c9:	e9 5f f0 ff ff       	jmp    8010542d <alltraps>
...
801063d0:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801063d5:	e9 53 f0 ff ff       	jmp    8010542d <alltraps>
...
801063dc:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801063e1:	e9 47 f0 ff ff       	jmp    8010542d <alltraps>
...
80106452:	e8 39 de ff ff       	call   80104290 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
801064c3:	e8 38 be ff ff       	call   80102300 <kfree>
      *pte = 0;
...
801064e1:	e8 0a ff ff ff       	call   801063f0 <walkpgdir>
    if(!pte)
...
8010650a:	c3                   	ret    
        panic("kfree");
8010650b:	c7 04 24 12 71 10 80 	movl   $0x80107112,(%esp)
...
80106523:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106526:	e8 65 d1 ff ff       	call   80103690 <cpuid>
...
801065cf:	c9                   	leave  
801065d0:	c3                   	ret    
801065d1:	eb 0d                	jmp    801065e0 <mappages>
801065d3:	90                   	nop
801065d4:	90                   	nop
801065d5:	90                   	nop
801065d6:	90                   	nop
...
801065ef:	8b 7d 14             	mov    0x14(%ebp),%edi
    *pte = pa | perm | PTE_P;
801065f2:	83 4d 18 01          	orl    $0x1,0x18(%ebp)
  a = (char*)PGROUNDDOWN((uint)va);
801065f6:	89 c3                	mov    %eax,%ebx
801065f8:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
801065fe:	8d 44 10 ff          	lea    -0x1(%eax,%edx,1),%eax
80106602:	29 df                	sub    %ebx,%edi
80106604:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106607:	81 65 e4 00 f0 ff ff 	andl   $0xfffff000,-0x1c(%ebp)
8010660e:	eb 15                	jmp    80106625 <mappages+0x45>
    if(*pte & PTE_P)
80106610:	f6 00 01             	testb  $0x1,(%eax)
80106613:	75 3d                	jne    80106652 <mappages+0x72>
    *pte = pa | perm | PTE_P;
80106615:	0b 75 18             	or     0x18(%ebp),%esi
    if(a == last)
...
80106632:	e8 b9 fd ff ff       	call   801063f0 <walkpgdir>
...
80106651:	c3                   	ret    
      panic("remap");
80106652:	c7 04 24 78 78 10 80 	movl   $0x80107878,(%esp)
80106659:	e8 02 9d ff ff       	call   80100360 <panic>
8010665e:	66 90                	xchg   %ax,%ax

80106660 <switchkvm>:
  lcr3(V2P(kpgdir));   // switch to the kernel page table
80106660:	a1 a4 55 11 80       	mov    0x801155a4,%eax
{
...
801066a4:	0f 84 c3 00 00 00    	je     8010676d <switchuvm+0xed>
  pushcli();
801066aa:	e8 61 da ff ff       	call   80104110 <pushcli>
...
8010675b:	5d                   	pop    %ebp
  popcli();
8010675c:	e9 6f da ff ff       	jmp    801041d0 <popcli>
    panic("switchuvm: no process");
80106761:	c7 04 24 7e 78 10 80 	movl   $0x8010787e,(%esp)
80106768:	e8 f3 9b ff ff       	call   80100360 <panic>
    panic("switchuvm: no pgdir");
8010676d:	c7 04 24 a9 78 10 80 	movl   $0x801078a9,(%esp)
80106774:	e8 e7 9b ff ff       	call   80100360 <panic>
    panic("switchuvm: no kstack");
80106779:	c7 04 24 94 78 10 80 	movl   $0x80107894,(%esp)
...
80106796:	83 ec 2c             	sub    $0x2c,%esp
80106799:	8b 75 10             	mov    0x10(%ebp),%esi
8010679c:	8b 55 08             	mov    0x8(%ebp),%edx
8010679f:	8b 7d 0c             	mov    0xc(%ebp),%edi
  if(sz >= PGSIZE)
801067a2:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
801067a8:	77 64                	ja     8010680e <inituvm+0x7e>
801067aa:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  mem = kalloc();
...
801067c2:	89 04 24             	mov    %eax,(%esp)
  mem = kalloc();
801067c5:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
801067c7:	e8 c4 da ff ff       	call   80104290 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
801067cc:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801067cf:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
801067d5:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
801067dc:	00 
801067dd:	89 44 24 0c          	mov    %eax,0xc(%esp)
801067e1:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801067e8:	00 
801067e9:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801067f0:	00 
801067f1:	89 14 24             	mov    %edx,(%esp)
801067f4:	e8 e7 fd ff ff       	call   801065e0 <mappages>
  memmove(mem, init, sz);
801067f9:	89 75 10             	mov    %esi,0x10(%ebp)
801067fc:	89 7d 0c             	mov    %edi,0xc(%ebp)
801067ff:	89 5d 08             	mov    %ebx,0x8(%ebp)
}
80106802:	83 c4 2c             	add    $0x2c,%esp
80106805:	5b                   	pop    %ebx
80106806:	5e                   	pop    %esi
80106807:	5f                   	pop    %edi
80106808:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106809:	e9 22 db ff ff       	jmp    80104330 <memmove>
    panic("inituvm: more than a page");
8010680e:	c7 04 24 bd 78 10 80 	movl   $0x801078bd,(%esp)
...
80106863:	e8 88 fb ff ff       	call   801063f0 <walkpgdir>
...
8010689d:	e8 ce b0 ff ff       	call   80101970 <readi>
...
801068c2:	c7 04 24 d7 78 10 80 	movl   $0x801078d7,(%esp)
801068c9:	e8 92 9a ff ff       	call   80100360 <panic>
    panic("loaduvm: addr must be page aligned");
801068ce:	c7 04 24 78 79 10 80 	movl   $0x80107978,(%esp)
...
801068e6:	83 ec 2c             	sub    $0x2c,%esp
801068e9:	8b 7d 10             	mov    0x10(%ebp),%edi
  if(newsz >= KERNBASE)
801068ec:	85 ff                	test   %edi,%edi
801068ee:	0f 88 8f 00 00 00    	js     80106983 <allocuvm+0xa3>
  if(newsz < oldsz)
801068f4:	3b 7d 0c             	cmp    0xc(%ebp),%edi
    return oldsz;
801068f7:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(newsz < oldsz)
801068fa:	0f 82 85 00 00 00    	jb     80106985 <allocuvm+0xa5>
  a = PGROUNDUP(oldsz);
80106900:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
80106906:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a < newsz; a += PGSIZE){
8010690c:	39 df                	cmp    %ebx,%edi
8010690e:	77 57                	ja     80106967 <allocuvm+0x87>
80106910:	eb 7e                	jmp    80106990 <allocuvm+0xb0>
80106912:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    memset(mem, 0, PGSIZE);
80106918:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
8010691f:	00 
80106920:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106927:	00 
80106928:	89 04 24             	mov    %eax,(%esp)
8010692b:	e8 60 d9 ff ff       	call   80104290 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80106930:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
80106936:	89 44 24 0c          	mov    %eax,0xc(%esp)
8010693a:	8b 45 08             	mov    0x8(%ebp),%eax
8010693d:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80106944:	00 
80106945:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
8010694c:	00 
8010694d:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80106951:	89 04 24             	mov    %eax,(%esp)
80106954:	e8 87 fc ff ff       	call   801065e0 <mappages>
80106959:	85 c0                	test   %eax,%eax
8010695b:	78 43                	js     801069a0 <allocuvm+0xc0>
  for(; a < newsz; a += PGSIZE){
8010695d:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106963:	39 df                	cmp    %ebx,%edi
80106965:	76 29                	jbe    80106990 <allocuvm+0xb0>
    mem = kalloc();
80106967:	e8 44 bb ff ff       	call   801024b0 <kalloc>
    if(mem == 0){
8010696c:	85 c0                	test   %eax,%eax
    mem = kalloc();
8010696e:	89 c6                	mov    %eax,%esi
    if(mem == 0){
80106970:	75 a6                	jne    80106918 <allocuvm+0x38>
      cprintf("allocuvm out of memory\n");
80106972:	c7 04 24 f5 78 10 80 	movl   $0x801078f5,(%esp)
80106979:	e8 d2 9c ff ff       	call   80100650 <cprintf>
  if(newsz >= oldsz)
8010697e:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106981:	77 47                	ja     801069ca <allocuvm+0xea>
      return 0;
80106983:	31 c0                	xor    %eax,%eax
}
80106985:	83 c4 2c             	add    $0x2c,%esp
80106988:	5b                   	pop    %ebx
80106989:	5e                   	pop    %esi
8010698a:	5f                   	pop    %edi
8010698b:	5d                   	pop    %ebp
...
80106990:	83 c4 2c             	add    $0x2c,%esp
...
801069f0:	5d                   	pop    %ebp
801069f1:	e9 8a fa ff ff       	jmp    80106480 <deallocuvm.part.0>
...
80106a1a:	e8 61 fa ff ff       	call   80106480 <deallocuvm.part.0>
...
80106a63:	e9 98 b8 ff ff       	jmp    80102300 <kfree>
    panic("freevm: no pgdir");
80106a68:	c7 04 24 29 79 10 80 	movl   $0x80107929,(%esp)
...
80106aab:	e8 e0 d7 ff ff       	call   80104290 <memset>
...
80106ad0:	e8 0b fb ff ff       	call   801065e0 <mappages>
...
80106b3e:	e8 ad f8 ff ff       	call   801063f0 <walkpgdir>
  if(pte == 0)
...
80106b4b:	c3                   	ret    
    panic("clearpteu");
80106b4c:	c7 04 24 3a 79 10 80 	movl   $0x8010793a,(%esp)
...
80106b66:	83 ec 2c             	sub    $0x2c,%esp
  ...
  char *mem;
  struct proc *curproc = myproc();
80106b69:	e8 42 cb ff ff       	call   801036b0 <myproc>
80106b6e:	89 45 dc             	mov    %eax,-0x24(%ebp)

  if((d = setupkvm()) == 0)
80106b71:	e8 0a ff ff ff       	call   80106a80 <setupkvm>
80106b76:	85 c0                	test   %eax,%eax
80106b78:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106b7b:	0f 84 8d 01 00 00    	je     80106d0e <copyuvm+0x1ae>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106b81:	8b 45 0c             	mov    0xc(%ebp),%eax
80106b84:	85 c0                	test   %eax,%eax
80106b86:	0f 84 ac 00 00 00    	je     80106c38 <copyuvm+0xd8>
80106b8c:	31 db                	xor    %ebx,%ebx
80106b8e:	eb 51                	jmp    80106be1 <copyuvm+0x81>
...
80106ba5:	e8 86 d7 ff ff       	call   80104330 <memmove>
...
80106bcd:	e8 0e fa ff ff       	call   801065e0 <mappages>
80106bd2:	85 c0                	test   %eax,%eax
80106bd4:	78 4d                	js     80106c23 <copyuvm+0xc3>
  for(i = 0; i < sz; i += PGSIZE){
80106bd6:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106bdc:	39 5d 0c             	cmp    %ebx,0xc(%ebp)
80106bdf:	76 57                	jbe    80106c38 <copyuvm+0xd8>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106be1:	8b 45 08             	mov    0x8(%ebp),%eax
80106be4:	31 c9                	xor    %ecx,%ecx
80106be6:	89 da                	mov    %ebx,%edx
80106be8:	e8 03 f8 ff ff       	call   801063f0 <walkpgdir>
80106bed:	85 c0                	test   %eax,%eax
80106bef:	0f 84 2c 01 00 00    	je     80106d21 <copyuvm+0x1c1>
    if(!(*pte & PTE_P))
80106bf5:	8b 30                	mov    (%eax),%esi
80106bf7:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106bfd:	0f 84 12 01 00 00    	je     80106d15 <copyuvm+0x1b5>
    pa = PTE_ADDR(*pte);
80106c03:	89 f7                	mov    %esi,%edi
    flags = PTE_FLAGS(*pte);
80106c05:	81 e6 ff 0f 00 00    	and    $0xfff,%esi
80106c0b:	89 75 e4             	mov    %esi,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
80106c0e:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80106c14:	e8 97 b8 ff ff       	call   801024b0 <kalloc>
80106c19:	85 c0                	test   %eax,%eax
80106c1b:	89 c6                	mov    %eax,%esi
80106c1d:	0f 85 6d ff ff ff    	jne    80106b90 <copyuvm+0x30>
  }
...
bad:
  freevm(d);
80106c23:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106c26:	89 04 24             	mov    %eax,(%esp)
80106c29:	e8 d2 fd ff ff       	call   80106a00 <freevm>
  return 0;
80106c2e:	31 c0                	xor    %eax,%eax


}
80106c30:	83 c4 2c             	add    $0x2c,%esp
80106c33:	5b                   	pop    %ebx
80106c34:	5e                   	pop    %esi
80106c35:	5f                   	pop    %edi
80106c36:	5d                   	pop    %ebp
...
80106c38:	8b 45 dc             	mov    -0x24(%ebp),%eax
80106c3b:	8b 40 7c             	mov    0x7c(%eax),%eax
80106c3e:	f7 d8                	neg    %eax
80106c40:	c1 e0 0c             	shl    $0xc,%eax
80106c43:	05 00 f0 ff 7f       	add    $0x7ffff000,%eax
80106c48:	3d ff ef ff 7f       	cmp    $0x7fffefff,%eax
80106c4d:	0f 87 b0 00 00 00    	ja     80106d03 <copyuvm+0x1a3>
80106c53:	bb 00 f0 ff 7f       	mov    $0x7ffff000,%ebx
80106c58:	eb 6a                	jmp    80106cc4 <copyuvm+0x164>
...
80106c75:	e8 b6 d6 ff ff       	call   80104330 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
...
80106c9d:	e8 3e f9 ff ff       	call   801065e0 <mappages>
80106ca2:	85 c0                	test   %eax,%eax
80106ca4:	0f 88 79 ff ff ff    	js     80106c23 <copyuvm+0xc3>
  for(i = t; i > t - (curproc->stack_pages) * PGSIZE; i -= PGSIZE){
80106caa:	8b 45 dc             	mov    -0x24(%ebp),%eax
80106cad:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
80106cb3:	8b 40 7c             	mov    0x7c(%eax),%eax
80106cb6:	f7 d8                	neg    %eax
80106cb8:	c1 e0 0c             	shl    $0xc,%eax
80106cbb:	05 00 f0 ff 7f       	add    $0x7ffff000,%eax
80106cc0:	39 d8                	cmp    %ebx,%eax
80106cc2:	73 3f                	jae    80106d03 <copyuvm+0x1a3>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106cc4:	8b 45 08             	mov    0x8(%ebp),%eax
80106cc7:	31 c9                	xor    %ecx,%ecx
80106cc9:	89 da                	mov    %ebx,%edx
80106ccb:	e8 20 f7 ff ff       	call   801063f0 <walkpgdir>
80106cd0:	85 c0                	test   %eax,%eax
80106cd2:	74 4d                	je     80106d21 <copyuvm+0x1c1>
    if(!(*pte & PTE_P))
80106cd4:	8b 30                	mov    (%eax),%esi
80106cd6:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106cdc:	74 37                	je     80106d15 <copyuvm+0x1b5>
    pa = PTE_ADDR(*pte);
...
80106ce9:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80106cef:	e8 bc b7 ff ff       	call   801024b0 <kalloc>
80106cf4:	85 c0                	test   %eax,%eax
80106cf6:	89 c6                	mov    %eax,%esi
80106cf8:	0f 85 62 ff ff ff    	jne    80106c60 <copyuvm+0x100>
80106cfe:	e9 20 ff ff ff       	jmp    80106c23 <copyuvm+0xc3>
...
80106d10:	e9 1b ff ff ff       	jmp    80106c30 <copyuvm+0xd0>
      panic("copyuvm: page not present");
80106d15:	c7 04 24 5e 79 10 80 	movl   $0x8010795e,(%esp)
80106d1c:	e8 3f 96 ff ff       	call   80100360 <panic>
      panic("copyuvm: pte should exist");
80106d21:	c7 04 24 44 79 10 80 	movl   $0x80107944,(%esp)
...
80106d3e:	e8 ad f6 ff ff       	call   801063f0 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
80106dac:	e8 7f d5 ff ff       	call   80104330 <memmove>
    len -= n;
    buf += n;
...
80106e06:	c7 44 24 04 9c 79 10 	movl   $0x8010799c,0x4(%esp)
80106e0d:	80 
80106e0e:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80106e15:	e8 46 d2 ff ff       	call   80104060 <initlock>
  acquire(&(shm_table.lock));
80106e1a:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80106e21:	e8 2a d3 ff ff       	call   80104150 <acquire>
...
80106e55:	e8 e6 d3 ff ff       	call   80104240 <release>
}
80106e5a:	c9                   	leave  
80106e5b:	c3                   	ret    
